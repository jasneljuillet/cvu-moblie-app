    ...
    >
      ...
      <View style={styles.aboutSection}>
        ...
        <Text style={styles.aboutText}>
          CVU San Limit is a basketball team established in Canapé-Vert in
          December 2019. Our mission is to promote the sport while fostering
          strong moral values among youth, both girls and boys.
        </Text>
      </View>
      {/* table */}
